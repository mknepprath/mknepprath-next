const posts: PostListItem[] = [
  ...
  },
  {
    "date": "2023-07-22",
    "id": "writing-code",
    "summary": "While it’s easy to fall into that trap of thinking that you’re writing for the computer. You’re not. You’re writing for other engineers...",
  ...
  },
  {
    ...
    "summary": "A mid-year check-in to see how I&apos;m doing on my goals for 2021.",
  ...
  },
  {
    ...
    "summary": "Memes are catchy and entertaining, but rarely capture the full scope of the problem at hand.",
  ...
  },
  {
    ...
    "summary": "Creating a simple page for displaying Minecraft server stats in Next.js.",
  ...
  },
  {
    ...
    "summary": "Examining the bumps along the road as I worked to add an RSS feed to my website.",
