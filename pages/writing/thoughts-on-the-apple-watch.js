...
export default () => (
  <BlogPage dateTime="2014-09-10" title="Thoughts on the Apple Watch">
    <header>
    ...
    <p>
      ...
      is that Apple has clearly been studying a great deal about how things work
      in the watch industry, addressing fashion first — because they’ve learned
      that regular people aren’t going to stick a big, ugly computer on their
      wrist no matter how many superpowers it grants them.
    </p>
    <p>
      I think the Watch is going to be a success in time, especially as it gets
      thinner over the next few generations.
    </p>
  </BlogPage>
);
