    ...
    <article>
      ...
      <ol>
        ...
        <li>
          ...
          like in the examples above, they are called a recipe. Many recipes
          have already been built and shared by others on the Browse page, the
          most popular being ‘When Facebook profile picture changes, update
        ...
        <li>
          ...
          it’s possible to build your own. Click on the Create tab and follow
          the seven steps to get the results you are looking for.
        </li>
        <li>
          <strong>Share your recipes.</strong> If you needed to build a recipe
          to receive updates from Jugglers Anonymous in your email, then you’re
          probably not the only one. Share your recipe on IFTTT for others to
          use.
        </li>
      </ol>
      <p>
