      ...
      <Page className={"container"}>
        ...
        <article>
          ...
          <p>
            ...
            most basic level, books are a long string of carefully curated
            words. There are tons of tools out there for organizing, formatting,
            and correcting these words, but not much out there for what I was
            planning to do. My story would be 3D, 4D, or even RealD when
            compared to the flatness of a book.
          </p>
          ...
          <p>
            ...
            notebook… but none of these seemed to suffice. It became obvious
            that for a multi-dimensional story like Lilt, I’d need a
...
<ul>Tweet "start" to begin.
  ...
  <li>asdfgh
    <ul>You can't do that yet.</ul>
          ...
          <p>
            I had the above list hosted on my site so I could view it as I
            updated the html. This allowed me to map out the branches a player
            could take as they made their way through the game. I also attempted
            to use{" "}
            ...
            neither could scale easily. I discovered over and over again how
            much I had underestimated the amount of content I’d have to generate
            for even a small, simple puzzle in this game.
          </p>
          ...
          <p>
            ...
            ants,” which would then be followed by a column of responses for
            “use blanket with ants,” “use bucket with ants,” “use coin with
            ants,” and so on.
          </p>

          <h2>Next Steps</h2>
          <p>
            Part 3 of this series will be coming soon, as I’ve started working
            on a prototype, and it’s already playable. Hit me up on Twitter,
