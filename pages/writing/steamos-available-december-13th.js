...
export default () => (
  <BlogPage dateTime="2013-12-12" title="SteamOS Available December 13th">
    <header>
      <h1>SteamOS Available December 13th</h1>
    </header>
    ...
    <p>
      ...
      media (films, games, etc)? I doubt they’d replace this set up with a Steam
      machine. Keyboards can be cumbersome on the couch, however, so I could see
      them getting the new controller if it is as precise as Steam says.
    </p>
  </BlogPage>
);
