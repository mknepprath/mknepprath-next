...
export default () => (
  <Page className={"container"} title={"Pokéfy Your Skype"}>
    <article>
      <header>
      ...
      <p>
        ...
        and bloops it emits when people log in or out, send messages to you,
        send you files, etc. I discovered yesterday (due to a prank) that you
        can actually set voice messages for each of these things, so I’ve put
        together a new Pokémon-themed Notifications scheme!{" "}
      </p>
      ...
      <p>
        Are you ready? A world of dreams and adventures with POKéMON awaits!
        Let’s go!
      </p>

      <p>
        <time dateTime="2014-04-02">April 2, 2014</time>
      </p>
    </article>
  </Page>
);
