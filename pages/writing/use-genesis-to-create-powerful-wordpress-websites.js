...
export default () => (
  ...
  >
    <article>
      ...
      <ol>
        <li>
          <strong>It’s optimized for search engines. </strong>It doesn’t take
          long to discover how important SEO is. Luckily, StudioPress has
          optimized Genesis to best take advantage of Google and the like. I’m
          not a pro at SEO, so I love this feature.
        </li>
        <li>
          <strong>
            There are tons of easily customizable themes available.
          </strong>
        ...
        <li>
          <strong>Unlimited everything, including updates. </strong>Many
          companies that deal with WordPress require that you pay for the next
          iteration of their theme. If you don’t, you run the risk of your
          website becoming out-of-date. That’s why I’m a fan of the Genesis
          model: you pay for a theme and you get unlimited updates and support.
          The support has already been invaluable for me, as well. I’ve run into
          a few issues, and they’ve helped me resolve them within a day.
        </li>
        <li>
          <strong>
            There are widgets built specifically for these themes.
          </strong>
          ...
          Featured Page, User Profile, and eNews and Updates. I’ve used most, if
          not all of these, and they all work beautifully.
        </li>
        <li>
          <strong>The design is wonderful.</strong> StudioPress knows what
          they’re doing when it comes to design. Everything looks great, and all
          themes start out looking very nice as well. Of course, you will want
          to change many of the graphics on these sites, but they give you a
          great head start, anyway.
        </li>
      </ol>
      <p>
