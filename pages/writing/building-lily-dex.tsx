    ...
    <p>
      ...
      <ul>
        ...
        <li>
          ...
          and it would be cool to have something original I could ship - unlike
          the example apps
        </li>
        <li>
          I'd been manually tracking the Pokémon I was missing in PoGo using a
          Notion doc
        </li>
        <li>
          This accomplished what I wanted, but was painful to keep up to date as
          new Pokémon were added
        </li>
        <li>
        ...
        <li>
          lily dex -lily, like lotad (original icon was a direct reference), pad
          like a notepad
        </li>
        <li>
        ...
        <li>Any new Pokémon in PoGo would require a full update to the app</li>
        <li>
          I was scraping data from the Silph Road catalog page -which
          actually... wasn't great data, full of errors
        </li>
        <li>
          Eventually found the PoGoAPI. We'll see how it goes? So far so good
        </li>
        <li>
        ...
        <li>
          At this point I published the app for beta testing in Singer's Airport
          app -approved!
        </li>
        <li>
