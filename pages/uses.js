  ...
  <Page className="container" title="Uses">
    <article>
      ...
      <ul>
        ...
        <li>
          <a href="https://matthewpalmer.net/vanilla/">Vanilla</a> by{" "}
          <a href="https://twitter.com/_matthewpalmer">Matthew Palmer</a>
        </li>
        <li>
        ...
        <li>
          ...
          <a href="https://twitter.com/SmallAnimalInc">Small Animal Studios</a>
        </li>
        <li>
          <a href="https://github.com/JohnCoates/Aerial">Aerial Screensaver</a>
        </li>
      </ul>
